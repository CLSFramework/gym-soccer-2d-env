...
class SampleEnv(Soccer2DEnv):
    def __init__(self, render_mode=None, logger=None):
        self.logger = logger
        if self.logger is None:
            self.logger = setup_logger('SampleEnv', log_dir, console_level=logging.DEBUG, file_level=logging.DEBUG)
        super(SampleEnv, self).__init__(render_mode, logger=self.logger)
